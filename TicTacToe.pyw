...
def choose():
    global player2
    me.setText('Select your opponent')
    me.setTextColor('black')
    me.setSize(15)
    c=init1('Friend','Computer-Easy','Computer-Hard')
    if c!=1:
        player2='Computer'
    entry()
    return c
...
def set2():
    ...
    me.setTextColor('black')
    me.setSize(12)
    c=Text(Point(100,100),'Ankit Kumar Jha')    
